...
int main(int argc,char* argv[]){
	...
	HANDLE mapping = CreateFileMapping(INVALID_HANDLE_VALUE, NULL, PAGE_READWRITE, 0, 256, (LPCTSTR)name);
	if (!mapping) { printf("couldn't map %s\n", name); return 0; }

	buf = (char*)MapViewOfFile(mapping, FILE_MAP_ALL_ACCESS, 0, 0, 0);
